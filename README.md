...
<div align="center">
  <img src="./public/logo.svg" alt="PixelProfiles — Windows displays — Screens" width="64" height="64">
  <h1>PixelProfiles — Windows displays — Screens</h1>
</div>

An independent project specification for Windows displays, covering display capability notes, layout profile sheets, baseline recovery instructions.
...
<img src="./public/screenshots/desktop-main.svg" alt="Windows displays — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Windows displays — compact concept, not a screenshot" width="250">
<br>
...
- **Display capability notes** — planned module; not implemented.
- **Layout profile sheets** — planned module; not implemented.
- **Baseline recovery instructions** — planned module; not implemented.

The proposed workflow separates display capability notes from layout profile sheets, with baseline recovery instructions retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Display capability notes**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="PixelProfiles — Windows displays — Screens — specification review workflow">
<br>
...
### Display capability notes

Define the input and expected outcome for module 1. Record the Windows displays version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Layout profile sheets

Define the input and expected outcome for module 2. Record the Windows displays version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Baseline recovery instructions

Define the input and expected outcome for module 3. Record the Windows displays version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Windows displays |
| Category | PC utility specification |
| Input | Manual notes or user-authorized local exports |
| Planned output | Display capability notes |
