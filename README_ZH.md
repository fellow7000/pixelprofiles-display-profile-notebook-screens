...
独立的项目设计文档，适用对象： **Windows displays**。
...
- **显示器能力说明** (Display capability notes) — 规划模块，尚未实现。
- **布局配置表** (Layout profile sheets) — 规划模块，尚未实现。
- **基准恢复说明** (Baseline recovery instructions) — 规划模块，尚未实现。
